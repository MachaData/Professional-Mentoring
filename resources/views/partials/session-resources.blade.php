...
{{-- Per-session join link + materials + survey. Expects $meetingUrl, $sessTools, $sessSurveys --}}
@if($meetingUrl || $sessTools->isNotEmpty() || $sessSurveys->isNotEmpty())
